...
abstract class AbstractModel {
    ...
    /*   
     * Classe abstraite représentant le model 
     *
     */ 
     ...
     * - lier l'id recherche au paramètre 
     ...
     * Algorithme :
     *
     * - exécuter une requête de sélection de tout les ligne de la table
     * - pour chaque lignes du résultat, créer un objet page, le remplir et le 
     *   stocker dans un tableau
     * - retourner le tableau
     * 
     * @static
     * @return Array renvoie un tableau d'objet modèle ou vide
     *
     */
